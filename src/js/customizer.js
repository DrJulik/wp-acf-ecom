...
function wdsCustomizer() {
	const headerButtonSelect = document.querySelector( '#customize-control-_header_button select' );

	if ( ! headerButtonSelect ) {
		return;
	}

	const headerLinkButton = document.querySelector( '#customize-control-_header_button_url' ),
		headerLinkText = document.querySelector( '#customize-control-_header_button_text' );
