 ...
 */
function _display_scaffolding_section( $args = array() ) {
	...
	$allowed_tags = _scaffolding_allowed_html();
	...
	<div class="scaffolding-document accordion <?php echo esc_attr( $class ); ?>">
		...
		<div class="accordion-item">
			...
			<header class="scaffolding-document-header display-flex flex-start space-between accordion-item-header">
				...
				<button type="button" class="scaffolding-button"><?php esc_html_e( 'Details', 'acf-test' ); ?></button>
			...
			<div class="scaffolding-document-content accordion-item-content">
				...
				<?php if ( $args['description'] ) : ?>
					<p><strong><?php esc_html_e( 'Description', 'acf-test' ); ?>:</strong></p>
					<p class="scaffolding-document-description"><?php echo esc_html( $args['description'] ); ?></p>
				<?php endif; ?>

				<?php if ( $args['parameters'] ) : ?>
					<p><strong><?php esc_html_e( 'Parameters', 'acf-test' ); ?>:</strong></p>
				...
				<?php if ( $args['arguments'] ) : ?>
					<p><strong><?php esc_html_e( 'Arguments', 'acf-test' ); ?>:</strong></p>
				...
				<?php if ( $args['usage'] ) : ?>
					<p><strong><?php esc_html_e( 'Usage', 'acf-test' ); ?>:</strong></p>
					<pre><?php echo esc_html( $args['usage'] ); ?></pre>
				<?php endif; ?>

				<?php if ( $args['output'] ) : ?>
					<p><strong><?php esc_html_e( 'HTML Output', 'acf-test' ); ?>:</strong></p>
 ...
 * @author Carrie Forde
 */
function _scaffolding_allowed_html() {
 ...
 * @author Carrie Forde
 */
function _display_global_scaffolding_section( $args = array() ) {
 ...
 * @author Carrie Forde
 */
function _hook_theme_scaffolding() {
...
add_action( '_scaffolding_content', '_hook_theme_scaffolding' );
