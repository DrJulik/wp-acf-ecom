 ...
 */
function _remove_default_customizer_sections( $wp_customize ) {
...
add_action( 'customize_register', '_remove_default_customizer_sections', 15 );
...
function _customize_scripts() {
	wp_enqueue_script( 'acf-test-customize-livepreview', get_template_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', array( 'jquery', 'customize-preview' ), '1.0.0', true );
}
